...
result_json = "%s/%s/replace_blend_reweight_%s_%s_%s.json" % (root, mode, scene, co, length) if scene != "snowy" else "/mnt/ve_share/songyuhao/generation/data/filtered_p2p_cn/ori/refine_blend_reweight_%s_%s_%s.json" % (root, mode, scene, co, length)
